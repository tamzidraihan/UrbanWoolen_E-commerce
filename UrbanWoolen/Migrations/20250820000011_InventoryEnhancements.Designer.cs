...
namespace UrbanWoolen.Migrations
{
    ...
    [Migration("20250820000011_InventoryEnhancements")]
    partial class InventoryEnhancements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UrbanWoolen.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UrbanWoolen.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UrbanWoolen.Models.SizeChart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UrbanWoolen.Models.SizeChartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UrbanWoolen.Models.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UrbanWoolen.Models.OrderItem", b =>
                {
                    b.HasOne("UrbanWoolen.Models.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("UrbanWoolen.Models.SizeChartItem", b =>
                {
                    b.HasOne("UrbanWoolen.Models.SizeChart", "SizeChart")
                        .WithMany("Items")
